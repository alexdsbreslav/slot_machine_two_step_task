function learning_experiment_notracking(trials, bars, practice,track)
    ...
    % check if practice or not
     if practice == 1 
         results_file_name = ['two_stage_task_sub' num2str(sub) '_practice'];
     else
        results_file_name = ['two_stage_task_sub' num2str(sub) '_bars' num2str(bars)];
     end
...
%         end
        ...
        if bars == 1 
            [bLind, pLind, bRind, pRind] = drawind(type,a(trial,:));
